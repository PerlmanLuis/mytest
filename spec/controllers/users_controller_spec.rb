...
describe UsersController do
  ...
  describe "GET 'show" do
    ...
    it "should show the user's microposts" do
      ...
      mp3 = Factory(:micropost, :user => @user, :content => "Foo bar foo")
      get :show, :id => @user
    ...
    it "should pagenate microposts" do
      35.times { Factory(:micropost, :user => @user, :content => "foo")}
      get :show, :id => @user
      response.should have_selector('div.pagination')
    end
    
    it "should display the micropost account" do
  ...
  describe "POST 'create'" do
    ...
    describe "success" do
      ...
      it "should have a welcome message" do
        post :create, :user => @attr
        flash[:success].should =~ /welcome to the test app/i
      end
